<?php
    ...
    echo "<div class='col-md-6'>
          <div class='box'>
            ...
            <div class='box-body'>
              ...
              <div class='alert alert-success alert-dismissible'>
                ...
                Diharapkan informasi akun sesuai, Jika terdapat kesalahan silahkan klik tautan dibawah <!--dengan identitas pada Kartu Pengenal anda, --> untuk ubah Profile anda klik <a href='".base_url()."administrator/edit_manajemenuser/".$this->session->username."'>disini</a>.
              </div>
            </div>
          </div>
        </div>
        ...
        $feedlist = new rss('https://pendmasurabaya.site/rss.xml'); /* Ubah link feed disini dengan link feed Anda */
        echo $feedlist->display(5,"Berita Terbaru"); /* Angka 7 digunakan untuk menampilkan jumlah artikel */
    echo "</section>";