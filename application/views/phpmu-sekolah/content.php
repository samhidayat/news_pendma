	...
	<div class="double-block">
		...
		<!--	<div class="block">
						...
						echo "<div style='margin-top:-10px' class='article'>
							<p>$no. $row[judul] <br>
								<span style='margin-left:15px; color:#dd8229'> $ket
									<a style='color:$color; font-style:italic' href='".base_url()."download/file_pengumuman/$file'>$file</a>
								</span>
							</p>
						</div>";
						$no++;
			...
			<div class="block">
				...
				<div class="block-content">
					<?php 
						$terbaru = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('berita.status' => 'Y', 'berita.headline'=>'N'),'id_berita','DESC',0,6);
