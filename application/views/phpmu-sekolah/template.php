...
<title><?php echo $title; ?></title>
	...
	<meta name="author" content="Pendma Kota Surabaya">
...
<body>
<div id='Back-to-top'>
  <img alt='Scroll to top' src='https://pendmasurabaya.site/asset/images/top.png'/>
</div>
					  ...
					  foreach ($iklanatas->result_array() as $b) {
						...
						if ($b['gambar'] != ''){
							if(preg_match("/swf\z/i", $string)) {
								...
								echo "<a href='$b[url]'><img width='100%' src='".base_url()."asset/foto_iklanatas/$b[gambar]' alt='$b[judul]' /></a>
