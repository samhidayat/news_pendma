	...
	<div class="article-title">
		...
		<div class="author">
			...
			<?php $test = md5(strtolower(trim($rows['email']))); 
				echo "<img src='https://pendmasurabaya.site/asset/foto_user/logo33.jpg?s=100'/>";
			?>
			</span>
			<div class="a-content">
				<span>By <b><?php echo "$rows[nama_lengkap]"; ?></b></span>
				<span class="meta"><?php echo tgl_indo($rows['tanggal']).", $rows[jam] WIB"; ?>
					<span class="tag" style="background-color: #ffffff;"><a href="<?php echo base_url()."kategori/detail/$rows[kategori_seo]"; ?>"><?php echo "$rows[nama_kategori]"; ?></a></span>
				</span>
			</div>
		</div>
	</div>
								...
								<?php
									...
									$komentar = $this->model_utama->view_where_ordering_limit('komentar',array('id_berita' => $rows['id_berita'],'aktif' => 'Y'),'id_komentar','ASC',0,100);
			  						foreach ($komentar->result_array() as $kka) {
										...
										if(($no % 2)==0){ $warna="#ffffff;"; }else{ $warna="#000000"; }
												...
												<div class='user-avatar'>
													<a href='#' class='hover-effect'>";
														if ($kka['email'] == ''){
															...
															echo "<img class='setborder' src='https://pendmasurabaya.site/asset/foto_user/logo33.jpg?s=100'/>";
														}
													echo "</a>
												</div>
...
<div class='main-sidebar right' style='width: 320px;'>
    <?php include "sidebar_kanan11.php";  ?>
	<?php include "sidebar_kiri1.php";  ?>
</div>
